...
class ChartingState extends MusicBeatState
{
        ...
        **/
        ...
        override function create()
        {
                ...
                else
                {
                        ...
                        _song = {
                                ...
                                holdCoverSkin: 'holdCover/holdCover',
                                player1: 'bf',
                                player2: 'dad',
                                gfVersion: 'gf',
                                speed: 1,
                ...
                var songInfo = PlayState.SONG.song;
                var songText:FlxText = new FlxText(20, 40, 0, songInfo.toString(), 16);
                songText.setFormat(Paths.font('funkin.ttf'), 32);
                ...
                for (i in 0...tipTextArray.length)
                {
                        ...
                        tipText.y += i * 12;
                        tipText.setFormat(Paths.font("funkin.ttf"), 14, FlxColor.WHITE, LEFT /*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
        ...
        function addSongUI():Void
        {
                ...
                if (skin == null)
                        skin = '';
                noteSkinInputText = new FlxUIInputText(player2DropDown.x, player2DropDown.y + 45, 150, skin, 8);
                ...
                holdCoverInputText = new FlxUIInputText(noteSplashesInputText.x, noteSplashesInputText.y + 35, 150, _song.holdCoverSkin, 8);
                blockPressWhileTypingOn.push(holdCoverInputText);

                var reloadNotesButton:FlxButton = new FlxButton(holdCoverInputText.x + 160, holdCoverInputText.y - 5, 'Change Notes', function()
                {
                ...
                tab_group_song.add(new FlxText(holdCoverInputText.x, holdCoverInputText.y - 15, 0, 'Hold Cover Texture:'));
        ...
        override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
        {
                ...
                else if (id == FlxUIInputText.CHANGE_EVENT && (sender is FlxUIInputText))
                {
                        ...
                        else if (sender == holdCoverInputText)
                        {
