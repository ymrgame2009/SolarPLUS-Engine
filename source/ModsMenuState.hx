...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (FlxG.random.bool(0.1))
			noModsTxt.text += '\nBITCH.'; // meanie
		noModsTxt.setFormat(Paths.font("funkin.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		buttonToggle.label.setFormat(Paths.font("funkin.ttf"), 24, FlxColor.WHITE, CENTER);
		...
		buttonUp.label.setFormat(Paths.font("funkin.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDown.label.setFormat(Paths.font("funkin.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonTop.label.setFormat(Paths.font("funkin.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonDisableAll.label.setFormat(Paths.font("funkin.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		buttonEnableAll.label.setFormat(Paths.font("funkin.ttf"), 24, FlxColor.BLACK, CENTER);
		...
		/*
			...
			installButton.label.setFormat(Paths.font("funkin.ttf"), 16, FlxColor.WHITE, CENTER);
			...
			removeButton.label.setFormat(Paths.font("funkin.ttf"), 16, FlxColor.WHITE, CENTER);
		...
		descriptionTxt.setFormat(Paths.font("funkin.ttf"), 32, FlxColor.WHITE, LEFT);
