...
class FunkinLua
{
	...
	public function new(script:String)
	{
		...
		Lua_helper.add_callback(lua, "addGridBG", function(tag:String, cellWidth:Int, cellHeight:Int, width:Int, height:Int, xVel:Int, yVel:Int)
		{
			...
			PlayState.instance.add(backdrop);
			PlayState.instance.variables.set(tag, backdrop);
		});
		Lua_helper.add_callback(lua, "addBackdrop", function(tag:String, image:String, xVel:Int, yVel:Int)
		{
...
class ModchartText extends FlxText
{
	...
	public function new(x:Float, y:Float, text:String, width:Float)
	{
		...
		setFormat(Paths.font("funkin.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
class DebugLuaText extends FlxText
{
	...
	public function new(text:String, parentGroup:FlxTypedGroup<DebugLuaText>, color:FlxColor)
	{
		...
		setFormat(Paths.font("funkin.ttf"), 20, color, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scrollFactor.set();
		borderSize = 1;
	}
