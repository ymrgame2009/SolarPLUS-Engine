...
class PsychBar extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, image:String = 'healthBarEmpty', valueFunction:Void->Float = null, boundX:Float = 0, boundY:Float = 1)
	{
		super(x, y);
		...
		bg = new FlxSprite().loadGraphic(Paths.image(image, 'shared'));
