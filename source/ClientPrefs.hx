...
class ClientPrefs
{
        ...
        public static var holdSplashAlpha:Float = 1;
        ...
        public static function saveSettings()
        {
                ...
                FlxG.save.data.quantRGB = quantRGB;
                ...
                FlxG.save.data.holdSplashAlpha = holdSplashAlpha;
        ...
        public static function loadPrefs()
        {
                ...
                if (FlxG.save.data.quantRGB != null)
                {
                        quantRGB = FlxG.save.data.quantRGB;
                }
                ...
                if (FlxG.save.data.holdSplashAlpha != null)
                {
                        holdSplashAlpha = FlxG.save.data.holdSplashAlpha;
                }
